...
public class InserirEntrevistado extends JFrame {
	...
	static Collection<String> nome1 = new ArrayList<>();
	static Collection<String> sexo1 = new ArrayList<>();
	static Collection<String> cor1 = new ArrayList<>();
	static Collection<String> estadoCivil1 = new ArrayList<>();
	static Collection<String> estado1 = new ArrayList<>();
	static Collection<String> pratica1 = new ArrayList<>();
	static Collection<String> resposta1 = new ArrayList<>();
	...
	static Collection<String> dados = new ArrayList<>();
